...
contract Rainbowzrd is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Rainbow Wizard";
    string constant _symbol = "WZRD";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10**_decimals);
    uint256 public _maxTxAmount = _totalSupply.div(150); // 1.5 %
